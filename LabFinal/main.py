...
hall.description = ("The empty hall smells of dried alcohol and rotten food.")

# link rooms
cavern.link_rooms(armoury,"south")
armoury.link_rooms(cavern,"north")
armoury.link_rooms(lab,"east")
hall.link_rooms(hall, "further south")
...
while running:
    ...
    # move
    if command in ["north", "south", "east", "west", "further south"]:
...
print("Thank you for playing Bradyn's Dungeon")